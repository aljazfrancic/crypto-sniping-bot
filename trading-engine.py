...
class TradingEngine:
    ...
    async def buy_token(self, token_address: str, amount_eth: float, min_tokens: float) -> Optional[str]:
        ...
        try:
            ...
            if tx_hash:
                logger.info(f"Buy order placed - Token: {token_address}, Amount: {amount_eth} ETH")
    ...
    async def sell_token(self, token_address: str, amount: int, min_eth: float) -> Optional[str]:
        ...
        try:
            ...
            if tx_hash:
                logger.info(f"Sell order placed - Token: {token_address}, Amount: {amount}")
